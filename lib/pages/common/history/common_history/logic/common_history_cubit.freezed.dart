...
/// Adds pattern-matching-related methods to [CommonHistoryState].
extension CommonHistoryStatePatterns on CommonHistoryState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(CommonHistoryViewModel content, SortType sortType)?
        content,
    ...
    switch (_that) {
      case Loading() when loading != null:
        return loading();
      case Content() when content != null:
        return content(_that.content, _that.sortType);
      case CustomError() when error != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(CommonHistoryViewModel content, SortType sortType)
        content,
