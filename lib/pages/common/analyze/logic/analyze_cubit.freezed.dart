...
/// @nodoc
mixin _$AnalyzeState implements DiagnosticableTreeMixin {
  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'AnalyzeState'));
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is AnalyzeState);
  }
...
/// @nodoc
class $AnalyzeStateCopyWith<$Res> {
  $AnalyzeStateCopyWith(AnalyzeState _, $Res Function(AnalyzeState) __);
}

/// Adds pattern-matching-related methods to [AnalyzeState].
extension AnalyzeStatePatterns on AnalyzeState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(
            AnalyzeViewModel content, AnalyzeViewModel? previousContent)?
        content,
    ...
    switch (_that) {
      case Loading() when loading != null:
        return loading();
      case Content() when content != null:
        return content(_that.content, _that.previousContent);
      case CustomError() when error != null:
...
class Loading with DiagnosticableTreeMixin implements AnalyzeState {
  const Loading();

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties..add(DiagnosticsProperty('type', 'AnalyzeState.loading'));
  }
...
class CustomError with DiagnosticableTreeMixin implements AnalyzeState {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ..add(DiagnosticsProperty('type', 'AnalyzeState.error'))
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AnalyzeState.error(error: $error)';
  }
}
