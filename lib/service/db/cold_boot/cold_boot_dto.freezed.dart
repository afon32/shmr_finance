...
/// Adds pattern-matching-related methods to [ColdBootDto].
extension ColdBootDtoPatterns on ColdBootDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ColdBootDto value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ColdBootDto() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ColdBootDto() when $default != null:
        return $default(_that.userId, _that.isColdBoot);
      case _:
        return orElse();
    }
  }
