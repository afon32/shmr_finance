...
/// Adds pattern-matching-related methods to [ApiAccountHistory].
extension ApiAccountHistoryPatterns on ApiAccountHistory {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApiAccountHistory value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccountHistory() when $default != null:
