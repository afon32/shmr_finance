...
/// Adds pattern-matching-related methods to [ApiAccountHistoryResponse].
extension ApiAccountHistoryResponsePatterns on ApiAccountHistoryResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApiAccountHistoryResponse value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccountHistoryResponse() when $default != null:
  ...
  TResult map<TResult extends Object?>(
    ...
    final _that = this;
    switch (_that) {
      case _ApiAccountHistoryResponse():
        return $default(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int accountId, String accountName, String currency,
            String currentBalance, List<ApiAccountHistory> history)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccountHistoryResponse() when $default != null:
        return $default(_that.accountId, _that.accountName, _that.currency,
            _that.currentBalance, _that.history);
      case _:
        return orElse();
    }
  }
