...
/// Adds pattern-matching-related methods to [ApiAccountState].
extension ApiAccountStatePatterns on ApiAccountState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApiAccountState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccountState() when $default != null:
