...
/// Adds pattern-matching-related methods to [ApiAccount].
extension ApiAccountPatterns on ApiAccount {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApiAccount value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccount() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, int userId, String name, String balance,
            String currency, String createdAt, String updatedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiAccount() when $default != null:
        return $default(_that.id, _that.userId, _that.name, _that.balance,
            _that.currency, _that.createdAt, _that.updatedAt);
      case _:
        return orElse();
    }
  }
